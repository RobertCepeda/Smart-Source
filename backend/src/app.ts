...
import { costCenterRouter } from "./modules/cost-centers/costCenter.routes";
...
import { quoteRequestRouter } from "./modules/quote-requests/quoteRequest.routes";
...
app.use("/api/cost-centers", costCenterRouter);
